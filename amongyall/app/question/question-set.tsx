...
export default function QuestionSet() {
    ...
    const questionSet = getAllCategories();


    // update previous words when set changes
    useEffect(() => {
    ...
    // Navigate to game screen with selected theme and words
        ...
        params: {
            ...
            words: JSON.stringify(questionSet)
        }
        });
    };

    const refreshPreview = () => {
        const words = getRandomPreviewQuestions(selectedSet);
        setPreviewQuestions(words);
    };
            ...
            <View style={styles.themeList}>
              {questionSet.map((question) => (
                <TouchableOpacity
                  ...
                  style={combineStyles(
                    styles.themeItem,
                    selectedSet === question && styles.themeItemSelected
                  )}
                  onPress={() => setSelectedSet(question)}
                >
                  <Text style={combineStyles(
                    textStyles.body,
                    selectedSet === question && styles.themeTextSelected
                  )}>
                    {question.normal}
                  </Text>
