    ...
    <ScrollView style={layoutStyles.container}>
      ...
      <View style={layoutStyles.content}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.bodyText}>For the purposes of this Privacy Policy:</Text>
          ...
          <View style={styles.definitionsList}>
            ...
            <Text style={styles.definitionItem}>
              <Text style={styles.bold}>Application</Text> refers to Amongyall, the software program provided by the Company.
            </Text>
            
            <Text style={styles.definitionItem}>
              <Text style={styles.bold}>Company</Text> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Amongyall.
            </Text>
            
            <Text style={styles.definitionItem}>
              <Text style={styles.bold}>Country</Text> refers to: Massachusetts, United States
            </Text>
          ...
          <Text style={styles.bodyText}>Usage Data is collected automatically when using the Service.</Text>
          ...
          <Text style={styles.bodyText}>The Company may use Personal Data for the following purposes:</Text>
          ...
          <View style={styles.bulletList}>
            ...
            <Text style={styles.bulletItem}>
              <Text style={styles.bold}>To provide You</Text> with news, special offers, and general information about other goods, services and events which We offer that are similar to those that you have already purchased or inquired about unless You have opted not to receive such information.
            </Text>
            <Text style={styles.bulletItem}>
          ...
          <Text style={styles.bodyText}>We may share Your personal information in the following situations:</Text>
          ...
          <View style={styles.bulletList}>
            ...
            <Text style={styles.bulletItem}>
              <Text style={styles.bold}>With Affiliates:</Text> We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy.
            </Text>
            <Text style={styles.bulletItem}>
          ...
          <Text style={styles.subsectionTitle}>Retention of Your Personal Data</Text>
          <Text style={styles.bodyText}>
            The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.
          </Text>

          <Text style={styles.subsectionTitle}>Delete Your Personal Data</Text>
          <Text style={styles.bodyText}>
          ...
          <Text style={styles.subsectionTitle}>Security of Your Personal Data</Text>
          <Text style={styles.bodyText}>
          ...
          <Text style={styles.contactInfo}>By email: amongyall2025@gmail.com</Text>
        </View>
      </View>
    </ScrollView>
  );
